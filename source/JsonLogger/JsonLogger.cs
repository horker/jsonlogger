...
namespace Horker.Logger
{
    public class JsonLogger : IDisposable
    {
        ...
        public JsonLogger(string logFile, bool append, string defaultSource = "")
        {
            _logFile = logFile;
        ...
        public JsonLogger(TextWriter writer, string defaultSource = "")
        {
            _logFile = null;
            _writer = writer;
            _defaultSource = defaultSource;
        ...
        {
            _writer.Write(HttpUtility.JavaScriptStringEncode(value, true));
        }
